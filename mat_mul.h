...
void cpu_mat_mul(float* h_A, float* h_B, float* h_C, int M_row, int width, int N_col);

void gpu_mat_mul(float* h_A, float* h_B, float* h_C, int M_row, int width, int N_col);
